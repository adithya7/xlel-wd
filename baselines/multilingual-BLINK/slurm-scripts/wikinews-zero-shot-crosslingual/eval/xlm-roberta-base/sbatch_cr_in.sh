...
DATA=$PWD/data/wikinews-zero-shot-crosslingual

cd multilingual-BLINK

BERT=xlm-roberta-base
MODEL=models/wikipedia-zero-shot-crosslingual/$BERT
TOPK=$MODEL/wikinews-zero-shot-crosslingual_retrieve_out/top8_candidates
OUT=$MODEL/wikinews-zero-shot-crosslingual_rank_out
